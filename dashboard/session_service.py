            ...
            with closing(s_conn) as conn:
                ...
                for r in all_s_rows:
                    ...
                    sessions_found.append({
                        ...
                        "last_updated_at": r["last_activity_at"] or ended or started,
        ...
        for s in recorded_sessions:
            ...
            if s_id and s_id not in seen_ids:
                ...
                sessions_found.append({
                    ...
                    "last_updated_at": s.get("last_updated_at") or s.get("last_activity_at") or s.get("ended_at") or s.get("started_at"),
