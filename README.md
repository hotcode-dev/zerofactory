...
| :--- | :--- | :--- |
| **[Orchestrator](profiles/orchestrator/SOUL.custom.md)** | Pipeline Overseer | Monitors the Kanban board, oversees the `kanban_decomposer` task breakdown, manages handoffs, and escalates blockers to the human. |
| **[Researcher](profiles/researcher/SOUL.custom.md)** | Technical Architect | Explores APIs, investigates optimal approaches, and writes detailed technical specs before coding begins. |
| **[Builder](profiles/builder/SOUL.custom.md)** | Senior Software Engineer | Writes the code. Focuses heavily on speed, type-safety, tests, and shipping features. |
| **[Reviewer](profiles/reviewer/SOUL.custom.md)** | Quality Gatekeeper | Reviews pull requests generated by the Builder. Looks for bugs, performance issues, and security flaws. |
| **[QA](profiles/qa/SOUL.custom.md)** | Testing Specialist | Verifies edge cases, runs integration tests, and ensures the code meets all acceptance criteria. |
| **[Scribe](profiles/scribe/SOUL.custom.md)** | Documentation Specialist | Keeps the README, API docs, and runbooks up to date alongside code changes. |

> **Note on modifications:** If you want to customize an agent's behavior or prompt, edit their `profiles/<agent>/SOUL.custom.md` file and run `make soul-merge`.
