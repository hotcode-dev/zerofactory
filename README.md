...
| **Scribe**<br>[SOUL](profiles/scribe/SOUL.custom.md) \| [Config](profiles/scribe/config.custom.yaml) | Documentation Specialist | Keeps the README, API docs, and runbooks up to date alongside code changes. |
